...
// 	selected          bool                    // whether or not an option as been selected
...
// 	const numMenuOptions = 4
// 	initialInputs := make(map[int]textinput.Model, numMenuOptions)
//
// 	// Setup Inputs with Labels
// 	// TOOD: These should not be textinputs.
// 	var t textinput.Model
// 	for idx := range numMenuOptions {
// 		t = textinput.New()
// 		switch idx {
// 		case 0:
// 			t.Prompt = "Home"
...
// 		case "enter":
// 			m.selected = true
// 			log.Default().Printf("Pressed Enter with focusedInputIndex of %d\n", m.focusedInputIndex)
// 			switch m.focusedInputIndex {
// 			case 0:
// 				return updateHomePage(msg, m)
// 			case 1:
// 				log.Default().Println("Creating Initial Deposit")
...
// }
//
// func (m ApplicationModel) UpdateDeposit(msg tea.Msg) (tea.Model, tea.Cmd) {
// 	log.Default().Println("Called DepositModel#Update")
// 	switch msg := msg.(type) {
// 	case tea.KeyMsg:
// 		switch msg.String() {
// 		case "q":
